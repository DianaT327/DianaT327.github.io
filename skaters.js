        ...
        const skatersData = [
            {
                ...
                achievements: ["Олимпийская чемпионка 2022", "Чемпионка мира 2021", "Чемпионка России 2022", "Обладательница Кубка России 2020"],
                birthDate: "28 марта 2004",
                coach: "Этери Тутберидзе",
                records: ["Первая женщина, исполнившая 4 флипа", "Рекордсменка по баллам", "Стабильность в сложных элементах"],
            ...
            },
            {
                ...
                category: "women",
                type: "Одиночное катание",
                achievements: ["Олимпийская серебряная медаль 2022", "Чемпионка мира среди юниоров", "5 четверных прыжков в программе", "Чемпионка России 2023"],
            ...
            },
            {
                ...
                category: "women",
                type: "Одиночное катание",
                achievements: ["Олимпийская чемпионка в команде 2022", "Чемпионка Европы 2022", "Чемпионка России 2022", "Победитель финала Гран-при"],
                birthDate: "26 апреля 2006",
                coach: "Этери Тутберидзе",
                records: ["Мировой рекорд по баллам", "Первая с четверным тулупом", "Самая юная чемпионка Европы"],
            ...
            },
            {
                ...
                category: "men",
                type: "Одиночное катание",
                achievements: ["Олимпийский чемпион в команде 2022", "Чемпион Европы 2022", "Чемпион России 2022", "Серебряный призер чемпионата России 2023"],
            ...
            },
            {
                ...
                category: "women",
                type: "Одиночное катание",
                achievements: ["Двукратная чемпионка мира", "Серебряная медаль Олимпиады 2018", "Чемпионка Европы", "Чемпионка России 2016, 2017"],
            ...
            },
            {
                ...
                category: "women",
                type: "Одиночное катание",
                achievements: ["Чемпионка России 2024", "Бронза чемпионата России 2023", "Победитель этапа Гран-при", "Чемпионка среди юниоров"],
            ...
            },
            {
                ...
                category: "women",
                type: "Одиночное катание",
                achievements: ["Чемпионка мира 2015", "Чемпионка Европы 2015", "Чемпионка России 2021", "Серебряный призер Чемпионата России 2023"],
            ...
            },
            {
                ...
                category: "men",
                type: "Одиночное катание",
                achievements: ["Чемпион России 2024", "Бронза чемпионата России 2023", "Призер этапов Гран-при", "Чемпион среди юниоров"],
                birthDate: "30 марта 2004",
                coach: "Алексей Мишин",
                records: ["Стабильные четверные", "Высокие баллы за технику", "Техничная подготовка"],
                description: "Чемпион России, техничный фигурист со стабильными четверными прыжками и хорошей артистичностью."
            },
            {
                id: 10,
                ...
                category: "men",
                type: "Одиночное катание",
                achievements: ["Серебро чемпионата России 2024", "Призер этапов Гран-при", "Участник чемпионата Европы", "Победитель международных турниров"],
                birthDate: "3 февраля 2003",
                coach: "Светлана Соколовская",
                records: ["Сложные вращения", "Артистичные программы", "Техническое разнообразие"],
                description: "Серебряный призер чемпионата России, известный своими артистичными программами и техничным исполнением."
            },
            {
                id: 11,
                ...
                category: "pairs",
                type: "Парное катание",
                achievements: ["Олимпийские чемпионы 2022", "Чемпионы мира 2021", "Чемпионы Европы 2022", "Чемпионы России 2021, 2022"],
                birthDate: "24.04.2001 / 14.08.1999",
                coach: "Артур Минчук",
            ...
            },
            {
                ...
                category: "pairs",
                type: "Парное катание",
                achievements: ["Бронза Олимпиады 2022", "Чемпионы Европы 2020", "Серебро чемпионата мира 2021", "Чемпионы России 2020"],
                birthDate: "23.01.2002 / 23.12.1999",
                coach: "Артур Минчук",
                records: ["Сложные выбросы", "Синхронные вращения", "Высокие поддержки"],
                description: "Олимпийские призеры, техничная пара с эффектными элементами. Известны своей зрелищностью."
            }
        ];
